...
DVM_PERMISSIONS = {
    "MANIFEST_PERMISSION" : {
		...
		"ACCESS_NOTIFICATION_POLICY" : [ "normal", "marker permission for notification policy", "Marker permission for applications that wish to access notification policy." ],
		"BIND_ACCESSIBILITY_SERVICE" : [ "signature", "ensure that only the system can bind the AccessibilityService", "Must be required by an AccessibilityService, to ensure that only the system can bind to it." ],
		"BIND_CARRIER_MESSAGING_SERVICE" : [ "signatureOrSystem" , "" , "" ],
		"BIND_CARRIER_SERVICES" : [ "signatureOrSystem" , "needed by system processess to bind services in carrier" , "The system process that is allowed to bind to services in carrier apps will have this permission" ],
		...
		"BIND_INCALL_SERVICE" : [ "signatureOrSystem" , "" , "Must be required by a InCallService, to ensure that only the system can bind to it." ],
		...
		"BIND_TELECOM_CONNECTION_SERVICE" : [ "signatureOrSystem" , "" , "Must be required by a ConnectionService, to ensure that only the system can bind to it." ],
		"BIND_TEXT_SERVICE" : [ "signature" , "" , "Must be required by a TextService (eg SpellCheckerService) to ensure that only the system can bind to it." ],
		...
		"READ_VOICEMAIL" : [ "signatureOrSystem" , "" , "Allows an application to read voicemails in the system." ],
		...
		"REQUEST_INSTALL_PACKAGES" : [ "normal" , "" , "Allows an application to request installing packages. Apps targeting APIs greater than 22 must hold this permission in order to use ACTION_INSTALL_PACKAGE." ],
		"TRANSMIT_IR" : [ "normal" , "" , "Allows using the device's IR transmitter, if available." ],
		"UNINSTALL_SHORTCUT" : [ "normal" , "" , "Allows an application to uninstall a shortcut in Launcher." ],
		"USE_FINGERPRINT" : [ "normal" , "" , "Allows an app to use fingerprint hardware." ],
		"WRITE_CALL_LOG" : [ "dangerous" , "" , "Allows an application to write (but not read) the user's contacts data." ],
		"WRITE_VOICEMAIL" : [ "signatureOrSystem" , "" , "Allows an application to modify and remove existing voicemails in the system." ],
    },
